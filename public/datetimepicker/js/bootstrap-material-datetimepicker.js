(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'ຍົກ​ເລີກ', okText: 'ຕົກ​ລົງ', clearText: '​ລ້າງ', nowText: '​ຕອນນີ້', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
