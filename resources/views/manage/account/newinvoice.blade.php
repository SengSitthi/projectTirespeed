          ...
          <div class="card">
            <div class="card-header bg-transparent py-15">
              <div class="row">
                ...
                <div class="col-md-4">
                  <a href="" class="btn btn-primary"><i class="mdi mdi-link"></i> ໜ້າລາຍ​ການ​ຮຽກ​ເກັບ</a>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input id="invoiceid" class="form-control" type="text" name="invoiceid" readonly required>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select id="qtid" name="qtid" style="width: 100%">
                        <option>*** ເລືອກ​ໃບ​ສະ​ເໜີ​ລາ​ຄາ ***</option>
                      </select>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select id="cpid" class="js-example-basic-multiple" name="cpid" multiple="multiple" style="width: 100%">
                        <option>*** ເລືອກ​ບໍ​ລິ​ສັດ ***</option>
                      </select>
                    </div>
                    <div class="form-group">
